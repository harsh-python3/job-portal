 ...
 <div>
     <div >
      <h3 className='text-lg font-bold mb-2 flex items-center gap-2'>
       ...
       <p className='text-primary/75 text-base mb-4'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Doloribus mollitia repudiandae rem illo, .</p>
...
{/* 2nd Part */}
    <div >
     <h3 className='text-lg font-bold mb-2 flex items-center gap-2 mt-24'>
      <FaRocket />
      Get Noticed Faster
      </h3>
      <p className='text-primary/75 text-base mb-4'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Doloribus mollitia repudiandae rem illo, .</p>
